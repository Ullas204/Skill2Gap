...
class OpenRouterProvider(LLMProvider):
    """OpenRouter via OpenAI-compatible API (openrouter.ai/api)."""
        ...
        if self._client is None or self._client.is_closed:
            self._client = httpx.AsyncClient(
                ...
                headers={
                    ...
                    "HTTP-Referer": "https://hirecraft.ai",
                    "X-Title": "AI Hiring Copilot",
                },
    ...
    async def chat(
        ...
        try:
            ...
            logger.error("OpenRouter provider failed: %s", exc)
            raise
